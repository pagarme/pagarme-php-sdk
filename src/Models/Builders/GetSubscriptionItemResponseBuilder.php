...
/**
 * Builder for model GetSubscriptionItemResponse
 *
 * @see GetSubscriptionItemResponse
 */
class GetSubscriptionItemResponseBuilder
{
    /**
    ...
    private function __construct(GetSubscriptionItemResponse $instance)
    {
    ...
    {
        return new self(new GetSubscriptionItemResponse());
    }
