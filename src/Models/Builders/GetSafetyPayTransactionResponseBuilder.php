...
use PagarmeApiSDKLib\Models\GetSafetyPayTransactionResponse;

/**
 * Builder for model GetSafetyPayTransactionResponse
 *
 * @see GetSafetyPayTransactionResponse
 */
class GetSafetyPayTransactionResponseBuilder
{
    /**
     * @var GetSafetyPayTransactionResponse
     */
    private $instance;

    private function __construct(GetSafetyPayTransactionResponse $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new get safety pay transaction response Builder object.
     */
    public static function init(): self
    {
        return new self(new GetSafetyPayTransactionResponse());
    }
    ...
    /**
     * Unsets bank tid field.
     */
    public function unsetBankTid(): self
    {
        $this->instance->unsetBankTid();
        return $this;
    }
    ...
    /**
     * Initializes a new get safety pay transaction response object.
     */
    public function build(): GetSafetyPayTransactionResponse
    {
