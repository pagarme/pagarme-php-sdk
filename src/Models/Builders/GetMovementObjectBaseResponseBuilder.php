...
/**
 * Builder for model GetMovementObjectBaseResponse
 *
 * @see GetMovementObjectBaseResponse
 */
class GetMovementObjectBaseResponseBuilder
{
    /**
     * @var GetMovementObjectBaseResponse
     */
    private $instance;

    private function __construct(GetMovementObjectBaseResponse $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new get movement object base response Builder object.
     */
    public static function init(): self
    {
        return new self(new GetMovementObjectBaseResponse());
    }
    ...
    /**
     * Initializes a new get movement object base response object.
     */
    public function build(): GetMovementObjectBaseResponse
    {
