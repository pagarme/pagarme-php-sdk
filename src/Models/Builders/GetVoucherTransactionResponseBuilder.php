...
/**
 * Builder for model GetVoucherTransactionResponse
 *
 * @see GetVoucherTransactionResponse
 */
class GetVoucherTransactionResponseBuilder
{
    /**
     * @var GetVoucherTransactionResponse
     */
    private $instance;

    private function __construct(GetVoucherTransactionResponse $instance)
    {
    ...
    {
        return new self(new GetVoucherTransactionResponse());
    }
