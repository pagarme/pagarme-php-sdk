 ...
 *
 * @see GetPixTransactionResponse
 */
class GetPixTransactionResponseBuilder
{
    /**
     * @var GetPixTransactionResponse
     */
    private $instance;

    private function __construct(GetPixTransactionResponse $instance)
    {
    ...
    {
        return new self(new GetPixTransactionResponse());
    }
    ...
    {
        $this->instance->setQrCodeUrl($value);
        return $this;
    }

    /**
     * Unsets qr code url field.
     */
    public function unsetQrCodeUrl(): self
    {
        $this->instance->unsetQrCodeUrl();
        return $this;
    }
    ...
    {
        $this->instance->setPixProviderTid($value);
        return $this;
    }

    /**
     * Unsets pix provider tid field.
     */
    public function unsetPixProviderTid(): self
    {
        $this->instance->unsetPixProviderTid();
        return $this;
    }
